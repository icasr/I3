...
The Manifest is located by checking for the following file names in order: `package.json` (as an extension of an NPM package.json format), `manifest.json`, `icasr.json`.
...
| `inputs.[].type`      | `string`         | Required, Enum('citations') | What inputs are accepted for this input type                                                                                                             |
...
| `outputs.[].type`     | `string`         | Required, Enum('citations') | The output type of the worker                                                                                                                            |
