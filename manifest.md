...
| `worker.type`         | `string`         | Enum('web', 'docker')       | How to handle worker process                                                                                                                             |
...
| `worker.url`          | `string`         | URL                         | URL exposed if `worker.type=='web'` this will receive the input data specified in `inputs`                                                               |
